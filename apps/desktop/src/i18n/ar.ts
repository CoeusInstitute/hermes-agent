...
export const ar = defineLocale({
  ...
  ide: {
    ...
    explorerEmptyTitle: 'لا توجد مساحة عمل مفتوحة',
    explorerEmptyBody: 'افتح بيئة Hermes IDE من نافذة مشروع لجلب مساحة عمله.',
    editorTitle: 'المحرر',
    editorEmptyTitle: 'لا يوجد ملف مفتوح',
    editorEmptyBody: 'اختر ملفًا من المستكشف لبدء التحرير.',
    chatTitle: 'المحادثة',
    chatEmptyTitle: 'لا توجد جلسات Hermes IDE بعد',
    chatEmptyBody: 'تعيش جلسات Hermes IDE هنا ضمن مساحة العمل هذه. ابدأ جلسة للعمل مع الوكيل.',
    browserTitle: 'المتصفح',
    browserEmptyTitle: 'لا توجد صفحة مفتوحة',
    browserEmptyBody: 'افتح عنوان URL لتصفحه هنا، ويمكن للوكيل التعامل معه معك.',
    toggleExplorer: 'تبديل المستكشف',
    toggleChat: 'تبديل المحادثة',
    toggleBrowser: 'تبديل المتصفح',
    resizeExplorer: 'تغيير حجم المستكشف',
    resizeChat: 'تغيير حجم المحادثة',
    resizeBrowser: 'تغيير حجم المتصفح',
    refreshExplorer: 'تحديث المستكشف',
    explorerUnreadable: error => `تعذّر قراءة هذا المجلد (${error}).`,
    editorTabsLabel: 'الملفات المفتوحة',
    closeTab: 'إغلاق',
    closeTabLabel: name => `إغلاق ${name}`,
    reloadFromDisk: 'إعادة التحميل من القرص',
    tooLargeTitle: 'الملف كبير جدًا للتحرير هنا',
    tooLargeBody: 'هذا الملف أكبر من 512 كيلوبايت. افتحه من معاينة المحادثة أو من محرر سطح المكتب.',
    loadFailedTitle: 'تعذّر فتح هذا الملف',
    closeDirtyTitle: 'إغلاق مع تغييرات غير محفوظة؟',
    closeDirtyBody: 'تحتوي هذه البطاقة على تعديلات لم تُحفظ على القرص.',
    closeDirtyConfirm: 'تجاهل التغييرات',
    diskChangedTitle: 'تغيّر الملف على القرص',
    diskChangedBody: 'قام شيء آخر بتحرير هذا الملف — تشغيل وكيل أو تطبيق آخر. الحفظ الآن سيستبدل تلك التغييرات.',
    overwrite: 'استبدال',
    chatTabsLabel: 'جلسات IDE',
    chatNew: 'جلسة IDE جديدة',
    chatRecent: 'جلسات IDE الأخيرة',
    chatCreateFailed: 'تعذّر بدء جلسة IDE',
    browserTabsLabel: 'علامات تبويب المتصفح',
    browserOpen: 'فتح المتصفح',
